...
async function importSetupSessionInternal(
  ...
  const derivedMetrics = deriveSessionMetrics(
    selectedDriver.laps.map((lap) => ({
      ...
      virtualEnergyRemaining: lap.virtualEnergyRemaining,
  ...
  const enrichedSessionInsert: SetupSessionInsert = {
    ...
    average_virtual_energy_used_per_lap: derivedMetrics.averageVirtualEnergyUsedPerLap,
    fuel_min_per_lap: derivedMetrics.fuelMinPerLap,
    fuel_max_per_lap: derivedMetrics.fuelMaxPerLap,
    virtual_energy_min_per_lap: derivedMetrics.virtualEnergyMinPerLap,
    virtual_energy_max_per_lap: derivedMetrics.virtualEnergyMaxPerLap,
    virtual_energy_start: derivedMetrics.virtualEnergyStart,
    virtual_energy_end: derivedMetrics.virtualEnergyEnd,
    ...
    projected_virtual_energy_20_minutes: derivedMetrics.projectedVirtualEnergy20Minutes,
    projected_virtual_energy_30_minutes: derivedMetrics.projectedVirtualEnergy30Minutes,
    projected_virtual_energy_45_minutes: derivedMetrics.projectedVirtualEnergy45Minutes,
